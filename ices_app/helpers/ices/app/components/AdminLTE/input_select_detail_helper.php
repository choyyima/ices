<?php
    ...
    class Input_Select_Detail extends Component_Engine{
        ...
        private $path = array(
            "view"=>'templates/app/components/input_select_detail/'
        );
        ...
        public function additional_script_render(){
            ...
            $js = str_replace(array("<script>","</script>"),""
                    ,get_instance()->load->view($this->path->view.'input_select_detail_js'
                        ,$param 
                        ,TRUE)
                    ); 
        ...
        public function html_render_first(){     
            ...
            $detail = '';
            $detail = get_instance()->load->view($this->path->view.'input_select_detail',$param,TRUE);
            $output = "";
            $output.='
