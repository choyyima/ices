...
class Rpt_Product_Stock_Bad extends MY_Controller {

    
    
    private $title='Report Product Stock Bad';
    private $title_icon = 'fa fa-bar-chart-o';
    private $path = array(
        'index'=>''
        ,'rpt_product_stock_bad_engine'=>''
        ,'ajax_search'=>''
        ,'rpt_product_stock_bad_js'=>''
        ,'product_view'=>''
    );
    ...
    function __construct(){
        ...
        $this->path->index=  get_instance()->config->base_url().'rpt_product_stock_bad/';
        $this->path->rpt_product_stock_bad_engine=  'report/product_stock_engine';
                        ...
                        'basic'=>'
                            select * from (
                                ...
                                from product_unit pu
                                    ...
                                    left outer join product_stock_bad t1 
