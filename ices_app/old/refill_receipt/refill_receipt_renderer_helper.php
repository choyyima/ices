<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Refill_Receipt_Renderer {
        ...
        public static function refill_receipt_components_render($app,$form,$is_modal){
            ...
            $temp_module_type = SI::type_list_get('refill_receipt_engine');
            $module_type_list = array();            
            foreach($temp_module_type as $idx=>$module_type){
                $module_type_list[] = array('id'=>$module_type['val'],'data'=>$module_type['label']);
            }
        ...
        public static function refill_receipt_allocation_view_render($app,$form,$data,$path){die('123');
            //<editor-fold defaultstate="collapsed">
