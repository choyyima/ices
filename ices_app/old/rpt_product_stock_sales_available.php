...
class Rpt_Product_Stock_Sales_Available extends MY_Controller {

    
    
    private $title='Report Product Stock Sales Available';
    private $title_icon = 'fa fa-bar-chart-o';
    private $path = array(
        'index'=>''
        ,'rpt_product_stock_sales_available_engine'=>''
        ,'ajax_search'=>''
        ,'rpt_product_stock_sales_available_js'=>''
        ,'product_view'=>''
    );
    ...
    function __construct(){
        ...
        $this->path->index=  get_instance()->config->base_url().'rpt_product_stock_sales_available/';
        $this->path->rpt_product_stock_sales_available_engine=  'report/product_stock_engine';
    ...
    {           
        ...
        $form->input_select_add()
                ...
                ;
        $js = ' $("#warehouse").on("change",function(){
                        ...
                        'basic'=>'
                            select * from (
                                ...
                                from product_unit pu
                                    ...
                                    left outer join product_stock_sales_available t1 
