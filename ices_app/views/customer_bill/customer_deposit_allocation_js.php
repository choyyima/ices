<script>
    ...
    var customer_bill_customer_deposit_allocation_init = function(){
        var parent_pane = $('#modal_customer_deposit_allocation')[0];
        customer_deposit_allocation_components_prepare();
        $('#modal_customer_deposit_allocation').find('#customer_deposit_allocation_sales_receipt').select2('disable');
    }
    ...
    $('#customer_deposit_allocation_new').on('click',function(){
        ...
        customer_bill_customer_deposit_allocation_init();
        $(parent_pane).find('#customer_deposit_allocation_sales_receipt').select2('enable');
