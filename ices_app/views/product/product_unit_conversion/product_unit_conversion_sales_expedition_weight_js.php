<script>
    var product_unit_conversion_sales_expedition_weight_methods = {
        show:function(){
            var lparent_pane = product_unit_conversion_parent_pane;
            $(lparent_pane).find('#product_unit_conversion_expedition').closest('.form-group').show();
        ...
        data_set:function(){
            ...
            switch(lmethod){
                ...
                case 'view':             
                    ...
                    var lajax_url = product_unit_conversion_data_support_url+'product_unit_conversion_sales_expedition_weight_get';
                    ...
                    $(lparent_pane).find('#product_unit_conversion_expedition').select2('data',{id:lresponse.expedition_id,text:lresponse.expedition_name});
                    $(lparent_pane).find('#product_unit_conversion_status').select2('data',
                        {id:lresponse.product_unit_conversion_status,
                            text:lresponse.product_unit_conversion_status_text
                        }
                    ).change();
        ...
        submit: function(){
            ...
            json_data.product_unit_conversion = {
                ...
                expedition_id:$(lparent_pane).find('#product_unit_conversion_expedition').select2('val')
            };
