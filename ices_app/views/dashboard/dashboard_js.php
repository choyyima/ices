<script>
    ...
    var dashboard = {
        ...
        dashboard_get:function(imodule_arr){
            ...
            var lajax_url = "<?php echo get_instance()->config->base_url() ?>"+'dashboard'+
                '/'+'data_support/data_get';
            var lresponse = null;
            lresponse = APP_DATA_TRANSFER.ajaxPOST(lajax_url,ldata).response;
